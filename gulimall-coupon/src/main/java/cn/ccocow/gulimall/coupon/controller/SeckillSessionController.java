...
import cn.ccocow.gulimall.coupon.entity.SeckillSessionEntity;
import cn.ccocow.gulimall.coupon.service.ISeckillSessionService;
...
public class SeckillSessionController {
  ...
  public PageResult list(@RequestParam Map<String, Object> params) {
    IPage<SeckillSessionEntity> res = seckillSessionService
        .lambdaQuery()
  ...
  public Result info(@PathVariable("id") Long id) {
          SeckillSessionEntity res = seckillSessionService.getById(id);
   ...
   */
  @PostMapping("/save")
  public Result save(@RequestBody SeckillSessionEntity seckillSessionEntity) {
   ...
   */
  @PostMapping("/update")
  public Result update(@RequestBody SeckillSessionEntity seckillSessionEntity) {
