...
import cn.ccocow.gulimall.product.entity.SpuImagesEntity;
import cn.ccocow.gulimall.product.service.ISpuImagesService;
...
public class SpuImagesController {
  ...
  public PageResult list(@RequestParam Map<String, Object> params) {
    IPage<SpuImagesEntity> res = spuImagesService
        .lambdaQuery()
  ...
  public Result info(@PathVariable("id") Long id) {
          SpuImagesEntity res = spuImagesService.getById(id);
   ...
   */
  @PostMapping("/save")
  public Result save(@RequestBody SpuImagesEntity spuImagesEntity) {
   ...
   */
  @PostMapping("/update")
  public Result update(@RequestBody SpuImagesEntity spuImagesEntity) {
