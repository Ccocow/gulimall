...
import cn.ccocow.gulimall.ware.entity.PurchaseEntity;
import cn.ccocow.gulimall.ware.service.IPurchaseService;
...
public class PurchaseController {
  ...
  public PageResult list(@RequestParam Map<String, Object> params) {
    IPage<PurchaseEntity> res = purchaseService
        .lambdaQuery()
  ...
  public Result info(@PathVariable("id") Long id) {
          PurchaseEntity res = purchaseService.getById(id);
   ...
   */
  @PostMapping("/save")
  public Result save(@RequestBody PurchaseEntity purchaseEntity) {
   ...
   */
  @PostMapping("/update")
  public Result update(@RequestBody PurchaseEntity purchaseEntity) {
